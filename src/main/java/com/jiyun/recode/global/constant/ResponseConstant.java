...
public class ResponseConstant {
	...
	public static final String LOGOUT_SUCCESS = "성공적으로 로그아웃되었습니다.";
	...
	public static final String INVALID_EMAIL = "인증받지 않은 이메일입니다.";
	...
	public static final String REFRESHTOKEN_NOT_FOUND = "이미 로그아웃된 사용자입니다.";
	public static final String TOKEN_VALIDATE_FAILURE = "토큰 검증에 실패했습니다.";
