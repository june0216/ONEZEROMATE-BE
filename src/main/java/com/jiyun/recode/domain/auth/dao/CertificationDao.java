package com.jiyun.recode.domain.auth.dao;
...
public class CertificationDao {
	...
	public void updateComfirmCertification(String email, String confirmCertificationCode) {
		stringRedisTemplate.opsForValue()
				.set(PREFIX + email, confirmCertificationCode, Duration.ofSeconds(LIMIT_TIME));
	}
